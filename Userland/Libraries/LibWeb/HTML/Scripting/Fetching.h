...
WebIDL::ExceptionOr<ScriptFetchOptions> get_descendant_script_fetch_options(ScriptFetchOptions original_options, URL::URL const& url, EnvironmentSettingsObject& settings_object);
